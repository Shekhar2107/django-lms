...
def student_community_view(request):
    return render(request, 'app/student_community.html')
...
@login_required
@lecturer_required
def but1_view(request):
    return render(request, 'app/but1.html')

@login_required
@lecturer_required
def lecturer_community_view(request):
    return render(request, 'app/lecturer_community.html')
