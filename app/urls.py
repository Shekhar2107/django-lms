...
from .views import (
    ...
    dashboard_view, student_community_view, community_view, but1_view, lecturer_community_view
) 
...
urlpatterns = [
    ...
    path('student_community/', student_community_view, name='student_community'),
    path('student_community/', community_view, name='student_community'),
    path('but1/', but1_view, name='but1'),
    path('lecturer_community/', lecturer_community_view, name='lecturer_community'),
